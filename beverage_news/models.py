...
class Article:
    ...
    discovery: str
    llm_summary: str = ""  # Generated by LLM post-extraction; replaces RSS summary in dashboard
    # URLs of duplicate articles merged into this one: list of "Source Name|||https://..."
